        ...
        const THEME_DEFAULTS = {
            ...
            hoverBg: "#f3f4f6", pressBg: "#f1f5f9", activeBg: "#eef2ff", chipBg: "#e2e8f0",
            themeColor: "#4f46e5",
        };
        const BG_THEMES = [
            ...
            { id: "butter",     name: "Butter",       bg: "#fdfaf0", neuDark: "rgba(200,180,110,0.35)", themeColor: "#c9a63f" },
            {
                ...
                activeBg: "rgba(99,102,241,0.18)", chipBg: "rgba(255,255,255,0.08)",
                themeColor: "#0a0a0f",
            },
        ];
        ...
        const BG_THEME_VAR_MAP = {
            ...
            hoverBg: "--hover-bg", pressBg: "--press-bg", activeBg: "--active-bg", chipBg: "--chip-bg",
        };
